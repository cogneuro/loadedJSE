...
output:
  html_document:
    ...
    highlight: tango
    code_folding: hide
subtitle: Working memory load on the joint Simon effect
...
pacman::p_load(tidyverse, psych, papaja, knitr) # data manipulation
pacman::p_load(afex, emmeans) # stats
pacman::p_load(cowplot, patchwork) # plot
pacman::p_load(permuco) # permutation
pacman::p_load(Superpower) # power analysis
